...
//                 <Button variant="outline" onClick={() => { setShowEditor(false); removeFile(); }} className="h-[48px] rounded-[8px] border-[#FF6900]">
//                   Cancel
//                 </Button>
//                 <Button onClick={applyEdit} className="bg-[#FF6900] h-[48px] rounded-[8px] hover:bg-[#e85e00]">
  ...
  () => import("@/app/(website)/create-campaigs/_components/ImageEditorModal"),
  {
    ...
    loading: () => (
      <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center">
        <div className="text-white text-2xl animate-pulse">Opening Editor...</div>
      </div>
    ),
  }
);
    ...
    <Card className="p-4 sm:p-6 lg:p-8 bg-[#2A2A2A] border-[#4B4B4B] mx-auto max-w-5xl">
      ...
      <div className="space-y-6 lg:space-y-8">
        ...
        <div>
          ...
          {/* Image Editor Modal – Dynamic + SSR Safe */}
          {showEditor && creative.preview && creative.format === "SINGLE_IMAGE" && (
            <ImageEditorModal
